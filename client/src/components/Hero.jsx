      ...
      <div className="w-full bg-black min-h-[90vh] flex flex-col lg:flex-row gap-5 p-6  md:gap-2 lg:px-20  text-white  ">
        ...
        <div className="w-full lg:w-2/2   lg:py-20 flex  flex-col  gap-8 ">
          ...
          <div className='flex mt-[-10px]  gap-8 flex-col '>
            ...
            <div className='flex gap-8 mt-2 w-[70%] md:w-[90%] text-center justift-center items-center'>

              <button
                className="whitespace-nowrap border px-4 py-3 bg-yellow-500 text-black rounded-lg shadow text-sm md:text-lg font-semibold"
                onClick={() => {
                  Navigate("/gallery");
                }}
              >
              ...
              <button className='whitespace-nowrap border px-4 py-3 bg-black text-white rounded-lg shadow text-sm md:text-lg font-semibold' onClick={() => { Navigate("/update") }}>
                Latest updates
              </button>
