...
const Updates = () => {
          ...
          <div className="flex md:grid md:grid-rows-1 flex-col md:grid-flow-col md:gap-20 overflow-x-auto wrap scroll-hidden">
            ...
            {loading
              ...
              Array.from({ length: 3 }).map((_, index) => (
                <div
                  key={index}
                  className="h-[25vh] w-[80vw] my-10 md:h-[300px] md:w-[530px] rounded-md bg-gray-900  border-1 p"
                >
                  <div className="h-full flex flex-col justify-start p-10 gap-y-6">
                    <div className="bg-gray-600 h-6 w-1/2 m-2 rounded animate__animated animate__flash animate__infinite"></div>
                    <div className="bg-gray-600 h-6 w-2/3 m-2 rounded animate__animated animate__flash animate__infinite"></div>
                    <div className="bg-gray-600 h-6 w-1/2 m-2 rounded animate__animated animate__flash animate__infinite"></div>
                    <div className="bg-gray-600 h-6 w-2/3 m-2 rounded animate__animated animate__flash animate__infinite"></div>
                  </div>
  ...
  ? Array.from({ length: 3 }).map((_, index) => (
      <div
        key={index}
        className="w-[80%] mx-auto h-[250px] md:h-[150px] my-5 border border-white rounded-md bg-cover bg-center animate-pulse bg-gray-600 animate__animated animate__fadeIn animate__fast"
      >
